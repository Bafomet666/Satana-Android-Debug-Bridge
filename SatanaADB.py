...
{0}            (/0\/0\ \  /\           {0}[ {1}Satana Sploit Alfa 1.0 {0}]{2}   
            `-^--'`<    |                          
           (_.)  _  )   /         
            `.___/`    /  
              `-----' /           
...
{1}  <----'  {2} `--' `.__,'\   {2} {1}    
  ...
  {0}[{1}8{0}] {2}Перезапустите Satana Sploit             {0}[{1}17{0}]{2} Grab wpa_supplicant         {0}[{1}26{0}]{2} Инструкции                          
  {0}[{1}9{0}] {2}Извлечь файлы с устройства              {0}[{1}18{0}]{2} Show Mac/Inet               {0}[{1}27{0}]{2} Metasploit   
  
  {0}[{1}R{0}] {2}Выйти и отключить adb server   {0}[{1}0{0}] {2}Очистить терминал       
...
def main():
    print (("\n{1}[{0}+{1}]{2} Твоя база данных, уязвимых устройств. Последние подключения.").format(REDL, GNSL, WHSL))
